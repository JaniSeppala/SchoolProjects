<?php
    ...
    else if (isset($_GET['order']) && $_SESSION['superuser']){
        $orderinfo = db_inspect_order_admin($_GET['order']);
        $orderrows = db_get_order_rows($_GET['order']);
    }
...
<html>
    ...
    ?>    
        ...
        ?>
        <a href="orders.php">RETURN TO ORDER LIST</a>
    <?php
        include '../footer.php';
    ?>
    </body>
